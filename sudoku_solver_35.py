# Alex Stephens, Neil Gahart, Emily Ramos
# method found at http://www.math.cornell.edu/~mec/Summer2009/meerkamp/Site/Solving_any_Sudoku_I.html
import sys
import time
...
def solve_from_file():
    ...
    newPuzzle=input('Enter a puzzle:' )
    f = open(newPuzzle, 'r')
    counter = 0
    for line in f:
        spl = line.split()
